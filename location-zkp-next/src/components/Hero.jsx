    ...
    >
      ...
      <div className="container relative text-center">
        {/* <p className="font-caudex text-4xl max-w-xl mx-auto text-blue-300 mb-5 tracking-tight italic">
          ✨ Empowering the decentralization of asset ownership through
          cryptographically secure, privacy-first NFT frameworks ✨
        </p> */}
        ...
        <p className="font-caudex text-3xl max-w-2xl mx-auto text-blue-400 mt-5 tracking-tight">
          Seamlessly mint NFTs tethered to geospatial parameters,
          fortified by advanced zero-knowledge proof methodologies
        </p>
        <div className="flex justify-center mt-7">
          <Link href="/home">
            <Button>Delve into Nexus</Button>
          </Link>
        </div>
      </div>
    </motion.section>
